...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-[#0a0a0a] p-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">
            Your academic brain, organized and beautiful.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-yellow-400 px-4 py-3 font-semibold text-black transition-transform hover:scale-[1.02] active:scale-[0.98]"
          >
